...
export default function SharedMatchDashBoard() {
  ...
  const stagesSharedMatch = MatchsShared.map(
    (stageSharedMatch) => stageSharedMatch.Stages
  );

  console.log(stagesSharedMatch);
  ...
  return (
    <div className="match-dashboard">
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 className="h2">Dashboard Matchs Shared</h1>
      ...
      <ChartMatch
        dataMatch={stagesSharedMatch}
        dataId={matchId}
        dataStage={stagesSharedMatch}
      />
